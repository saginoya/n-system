...
import NBreakpointSwitcher from '@/components/entries/interaction/NBreakpointSwitcher.ce.vue'
...
<template>
  <NContainerFlex align-items="stretch" class="h-auto sm:h-full">
    ...
    <NContainerFlex
      ...
      align-items="center"
      justify="center"
      class="h-auto w-full sm:h-full sm:w-auto"
    >
      <NBreakpointSwitcher sm>
        <NIcon name="arrow-down" />
        <template v-slot:sm>
          <NIcon name="arrow-right" />
        </template>
      </NBreakpointSwitcher>
    </NContainerFlex>
  </NContainerFlex>
