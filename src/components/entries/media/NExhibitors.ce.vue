...
import NTooltipInfo from '@/components/entries/interaction/NTooltipInfo.ce.vue'
...
import ExhibitorListHeading from '@/components/features/ExhibitorListHeading.vue'
import ExhibitorListItem from '@/components/features/ExhibitorListItem.vue'
import ExhibitorListNotApplicable from '@/components/features/ExhibitorListNotApplicable.vue'
import ExhibitorProfile from '@/components/features/ExhibitorProfile.vue'
    ...
    <NCard>
      ...
      <NContainerFlex justify="between" class="border-b border-b-slate-200">
        <NContainerFlex align-items="center" gap="2">
          ...
          <NTooltipInfo icon="question" location="bottom">
            <div v-if="lang === 'ja'">
